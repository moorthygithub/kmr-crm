...
const Dashboard = () => {
  ...
  const totalTrialUserCount = results?.totalTrialUser_count || 0;
  const totalInactiveUserCount = results?.totalInactiveUser_count || 0;
  const totalUserCount = results?.totalUser_count || 0;
  const renewalCount = results?.renewal_count || 0;
