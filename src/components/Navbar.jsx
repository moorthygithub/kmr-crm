...
//             <p className="text-gray-700 w-96 h-20 text-xl font-bold">
...
const Navbar = ({
  ...
  return (
    <nav className="bg-white border-b border-gray-200 fixed w-full top-0 z-50">
      <div className="px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <button
              onClick={() => navigate("/profile")}
              className="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-300 bg-gray-200 rounded-lg transition-colors"
            >
              Profile
            </button>
            <button
      ...
      >
        <DialogTitle id="logout-dialog-title" sx={{ fontWeight: 600 ,fontSize:"1.5rem"}}>
          {" "}
          Confirm Logout
        </DialogTitle>
        <DialogContent>
